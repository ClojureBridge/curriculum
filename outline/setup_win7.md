...
If you do not know if you are running 32-bit or 64-bit Windows, go to the Control Panel and choose "System and Security" and then "System." You should see a window like the following:
